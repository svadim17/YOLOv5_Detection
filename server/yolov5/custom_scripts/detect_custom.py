...
if __name__ == '__main__':
    ...
    from server.yolov5 import detect

    print(
        detect.run(weights=r"C:\Users\v.stecko\Desktop\YOLOv5 Project\yolov5\runs\train\yolov5m_6classes_BIG_AUGMENTATED_ver3\weights\best.pt",
